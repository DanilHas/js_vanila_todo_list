...
imagePlus.src = './assets/icons/Plus.svg';
...
document.addEventListener('click', function (event) {
  ...
  if (event.target.className === 'todo-list__add-button' || taskContainer.contains(event.target)) {
    return;
  }
...
function renderTasks() {
  ...
  tasksStore.forEach((task) => {
    ...
    taskUpdatingDate.textContent = new Date().toDateString();
    ...
    imageDeleteButton.src = '../js_vanila_todo_list/assets/icons/DeleteIcon.svg';
